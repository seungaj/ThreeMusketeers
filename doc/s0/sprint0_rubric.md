...
## Formatting (Max 4 marks) 
  ...
  Formatting Total Mark: 3 / 4

---
## Total Mark  
Sprint 0 Total Mark : 20 / 22
	
## Notes
- Your user stories should be formatted as follows: "User Story X,Y" where X => sprint # you will be working on, Y => story number for that sprint
  Example:
    User Story 1.1
    User Story 1.2
    User Story 2.1
...
- designPatterns.pdf does not provide detailed explanations of **how you will implement**, **what its usage solves** for some design patterns.
